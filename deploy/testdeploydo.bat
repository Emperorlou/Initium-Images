...
git -C c:\Universe\Initium-Resources pull

cd "C:\Program Files\Java\jdk1.7.0\bin"

call C:\appengine-java-sdk-1.9.36\appengine-java-sdk-1.9.36\bin\appcfg.cmd -V test update c:\Universe\Initium-Resources\war
